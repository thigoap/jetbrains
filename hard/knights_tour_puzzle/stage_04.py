# Knight's Tour Puzzle - Stage 04
# https://hyperskill.org/projects/141/stages/749/implement
...
print("Knight's Tour Puzzle - Stage 04\n")
...
def update_matrix(board_dimension, current_pos, visited_pos=[]):
    ...
    possible_moves, len_pos = check_possibilities(columns, lines, current_pos)
    ...
    for line in board_matrix:
        for position in line:
            if position == current_pos:
                ...
                possible, num_possibilities = check_possibilities(columns, lines, position)
